...
def build_prompt(
    ...
    if existing_yaml:
        ...
        parts.append("Modify existing automation according to the request; keep stable parts unchanged.")
    if style:
    ...
    parts.append("When uncertain, explain assumptions and return warnings instead of guessing.")
    return "\n".join(parts)
